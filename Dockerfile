...
RUN apt-get update && apt-get install -y  git-core libcurl4-openssl-dev libgit2-dev libssh2-1-dev libssl-dev libxml2-dev libpython3-dev python3-pip make pandoc pandoc-citeproc zlib1g-dev && rm -rf /var/lib/apt/lists/*
